...
### Uso do bash [](l:tools_bash t:side r:tools_basic +tools)

- [ ] [Uso do Bash e Instalação do Git Bash](../wiki/configure/bash_git.md)

### Configuração do Ambiente [](l:tools_local_ide r:tools_bash t:side)

- [ ] [Instalação do C++ (Mingw)](../wiki/configure/cpp.md)
- [ ] [IDE: Visual Studio Code (vscode)](../wiki/configure/vscode.md)

### Makefile [](l:tools_makefile t:side r:tools_basic)

- [ ] filler
- [ ] filler
- [ ] filler

### Primeiro código [](l:types_basic r:tools_basic t:main)
...
### Casting e Conversão [](l:types_casting t:side r:types_basic +types)

- [ ] [Conversão entre tipos (casting)](../wiki/variaveis/casting.md)
- [ ] [stoi stod strtol strtod]()

### Conversão [](l:types_conversion t:side r:types_basic +types)
...
- [ ] [Operações aritméticas +, -, *, /](../wiki/operacoes/operacoes.md)
...
### Entrada e Saída - puts, printf, scanf [](l:io_basic t:main r:types_operations +io)
...
### Entrada e Saída - sprintf [](l:io_string t:side r:string_novice +io)

### Entrada e Saída - flush [](l:io_error t:side r:repeat_novice +io)

### Macros  [](l:tools_macros t:side r:repeat_novice +tools)

### TKO - Ferramenta de Testes [](l:tools_tko t:main r:tools_basic +tools)

- [ ] [Ferramenta de Testes: TKTest](../wiki/tko/Readme.md)

### Seleção Básica [](l:select_novice t:main r:io_basic r:style_guide r:style_indentation +select)
...
### Debugando [](l:tools_debug t:side r:tools_basic +tool)

- [ ] [Debugando o primeiro código](../wiki/debugando/intro.md)

### Técnicas de seleção I [](l:select_advanced t:side r:functions_novice +selct +algo)
...
### Técnicas de seleção II [](l:select_expert t:side r:select_advanced +select +algo) 
...
### argc e argv [](l:io_argc_argv t:side r:types_conversion +io)
