...
### Configuração do Ambiente `+tools:30`<!-- l:tools_local_ide r:tools_bash c:pink -->
...
### Primeiro código `+types:30`<!-- l:types_basic r:tools_basic c:lime -->
...
### Seleção Básica `+select:10`<!-- l:select_novice c:lime r:io_basic r:style_guide r:style_indentation -->
...
### Strings `+types:10 +select:10`<!-- l:string_novice c:lime r:array_advanced -->
