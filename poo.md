...
## 00. Configuração de ambiente <!-- @config -->

- [Introdução ao git](pages/git/README.md) <!-- @001 -->
...
## 02. Entendendo Classes, a Main e os Testes <!-- @main r:config -->
...
## 02. Modificadores de Acesso <!-- @access r:main -->

- [Garante uma hora válida no @relogio](base/relogio/Readme.md)

## 03. Agregação Simples <!-- @aggregation r:access -->
...
## 04. ArrayList I - Listas <!-- @arraylist r:aggregation -->
...
## 05. ArrayList II - Arrays de Null <!-- @arraylist2 r:arraylist -->
...
## 06. ArrayList III - Composição e Enum <!-- @arraylist3 r:arraylist2 -->
...
## 09. Mapas && Exceções II <!-- @map2 r:inheritance -->
...
## 10. Referências Cruzadas <!-- @cross r:map2 -->
...
## 11. Em atualização <!-- @update r:cross -->
...
## 12. Modelos em Avaliação <!-- @evaluate r:update -->
